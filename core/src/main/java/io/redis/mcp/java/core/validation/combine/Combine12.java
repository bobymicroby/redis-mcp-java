...
import io.redis.mcp.java.core.validation.f.F12;
import io.redis.mcp.java.core.validation.Result;

/**
 * @author Borislav Ivanov
 */
public class Combine12<A, B, C, D, E, F, G, H, I, J, K, L, TError> {
        ...
        public <M> Result<M, TError> with(F12<A, B, C, D, E, F, G, H, I, J, K, L, M> f) {
                                                            ...
                                                            resultG.andThen(g ->
                                                                    resultH.andThen(h ->
                                                                            resultI.andThen(i ->
                                                                                    resultJ.andThen(j ->
                                                                                            resultK.andThen(k ->
                                                                                                    resultL.map(l -> f.apply(a, b, c, d, e, f_, g, h, i, j, k, l))
                                                                                            )
                                                                                    )
                                                                            )
                                                                    )
