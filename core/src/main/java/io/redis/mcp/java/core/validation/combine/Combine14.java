...
import io.redis.mcp.java.core.validation.f.F14;
...
public class Combine14<A, B, C, D, E, F, G, H, I, J, K, L, M, N, TError> {
        ...
        public <O> Result<O, TError> with(F14<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> f) {
                                                                            ...
                                                                            resultI.andThen(i ->
                                                                                    resultJ.andThen(j ->
                                                                                            resultK.andThen(k ->
                                                                                                    resultL.andThen(l ->
                                                                                                            resultM.andThen(m ->
                                                                                                                    resultN.map(n -> f.apply(a, b, c, d, e, f_, g, h, i, j, k, l, m, n))
                                                                                                            )
                                                                                                    )
                                                                                            )
                                                                                    )
